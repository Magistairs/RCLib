...
void LogControlWidget::ConnectSignals()
{
    connect(m_levelCombo, QOverload<int>::of(&QComboBox::currentIndexChanged),
            this, &LogControlWidget::OnLevelChanged);
    connect(m_consoleOutput, &QCheckBox::toggled,
            this, &LogControlWidget::OnConsoleOutputToggled);
    connect(m_fileOutput, &QCheckBox::toggled,
            this, &LogControlWidget::OnFileOutputToggled);
    connect(m_saveButton, &QPushButton::clicked,
            this, &LogControlWidget::OnSaveLog);
    connect(m_clearButton, &QPushButton::clicked,
            this, &LogControlWidget::OnClearLog);
}
...
void LogControlWidget::OnSaveLog()
{
    QString filePath = QFileDialog::getSaveFileName(this,
        "Save Log File", "", "Log Files (*.log);;All Files (*)");
